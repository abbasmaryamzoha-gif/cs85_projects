...
/*
DEBUGGING LOG:
added a variable $nameLength for name length since it was used multiple times
forgot to include $ when referencing some variables ($i in for loop is easy to miss),
I installed an extension for php that shows undeclared variables, since vscode doesn't do that on its own
forgot to add spaces when adding strings to $cssClass
*/
            ?>
        </div>
    </div>
